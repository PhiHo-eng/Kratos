...
namespace Kratos
{
    ...
    KRATOS_CREATE_VARIABLE( double, YOUNGS_MODULUS_SENSITIVITY)
     KRATOS_CREATE_VARIABLE( double, DCDX_DISPLACMENT_CONTROLLED_X )
    KRATOS_CREATE_VARIABLE( double, DCDX_DISPLACMENT_CONTROLLED_Y )
    KRATOS_CREATE_VARIABLE( double, DCDX_DISPLACMENT_CONTROLLED_Z )
    KRATOS_CREATE_VARIABLE( double, MAX_MEAN_STRESS)
    ...
    KratosTopologyOptimizationApplication::KratosTopologyOptimizationApplication() 
        : KratosApplication("TopologyOptimizationApplication"),
            ...
            mAdjointSmallDisplacementSIMPElement3D8N( 0, Element::GeometryType::Pointer(new Hexahedra3D8<NodeType >(Element::GeometryType::PointsArrayType(8)))){}
    ...
    void KratosTopologyOptimizationApplication::Register()
    {
        ...
        KRATOS_REGISTER_ELEMENT( "AdjointSmallDisplacementSIMPElement3D8N", mAdjointSmallDisplacementSIMPElement3D8N );
        ...
        KRATOS_REGISTER_VARIABLE( DCDX_DISPLACMENT_CONTROLLED_X)
        KRATOS_REGISTER_VARIABLE( DCDX_DISPLACMENT_CONTROLLED_Y )
        KRATOS_REGISTER_VARIABLE( DCDX_DISPLACMENT_CONTROLLED_Z)        
