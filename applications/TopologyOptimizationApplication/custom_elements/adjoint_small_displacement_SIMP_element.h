...
#if !defined(ADJOINT_SMALL_DISPLACEMENT_SIMP_ELEMENT_H_INCLUDED )
#define  ADJOINT_SMALL_DISPLACEMENT_SIMP_ELEMENT_H_INCLUDED
...
/** \brief AdjointSmallDisplacementSIMPElement
 *
...
class AdjointSmallDisplacementSIMPElement : public AdjointFiniteDifferencingBaseElement<TPrimalElement>
{
public:
    ...
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(AdjointSmallDisplacementSIMPElement);

    AdjointSmallDisplacementSIMPElement(IndexType NewId = 0)
    : BaseType(NewId, false)
    {
    }

    AdjointSmallDisplacementSIMPElement(IndexType NewId, typename GeometryType::Pointer pGeometry)
    : BaseType(NewId, pGeometry, false)
    {
    }

    AdjointSmallDisplacementSIMPElement(IndexType NewId,
    ...
    {
        return Kratos::make_intrusive<AdjointSmallDisplacementSIMPElement<TPrimalElement>>(
