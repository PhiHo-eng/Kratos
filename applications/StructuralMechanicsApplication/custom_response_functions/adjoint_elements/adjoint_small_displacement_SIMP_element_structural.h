...
#if !defined(ADJOINT_FINITE_DIFFERENCE_SMALL_DISPLACEMENT_SIMP_ELEMENT_STRUCTURAL_H_INCLUDED )
#define  ADJOINT_FINITE_DIFFERENCE_SMALL_DISPLACEMENT_SIMP_ELEMENT_STRUCTURAL_H_INCLUDED
...
/** \brief AdjointSmallDisplacementSIMPElementStructural
 *
...
class AdjointSmallDisplacementSIMPElementStructural : public AdjointFiniteDifferencingBaseElement<TPrimalElement>
{
public:
    ...
    KRATOS_CLASS_INTRUSIVE_POINTER_DEFINITION(AdjointSmallDisplacementSIMPElementStructural);

    AdjointSmallDisplacementSIMPElementStructural(IndexType NewId = 0)
    : BaseType(NewId, false)
    {
    }

    AdjointSmallDisplacementSIMPElementStructural(IndexType NewId, typename GeometryType::Pointer pGeometry)
    : BaseType(NewId, pGeometry, false)
    {
    }

    AdjointSmallDisplacementSIMPElementStructural(IndexType NewId,
    ...
    {
        return Kratos::make_intrusive<AdjointSmallDisplacementSIMPElementStructural<TPrimalElement>>(
