...
#include "adjoint_small_displacement_SIMP_element_structural.h"
...
void AdjointSmallDisplacementSIMPElementStructural<TPrimalElement>::CalculateStressDisplacementDerivative(const Variable<Vector>& rStressVariable,
...
template <class TPrimalElement>
int AdjointSmallDisplacementSIMPElementStructural<TPrimalElement>::Check(const ProcessInfo& rCurrentProcessInfo) const
{
    KRATOS_TRY;
...
template <class TPrimalElement>
void AdjointSmallDisplacementSIMPElementStructural<TPrimalElement>::save(Serializer& rSerializer) const
{
    KRATOS_SERIALIZE_SAVE_BASE_CLASS(rSerializer, BaseType);
}

template <class TPrimalElement>
void AdjointSmallDisplacementSIMPElementStructural<TPrimalElement>::load(Serializer& rSerializer)
{
    KRATOS_SERIALIZE_LOAD_BASE_CLASS( rSerializer, BaseType);
}

template class AdjointSmallDisplacementSIMPElementStructural<SmallDisplacementSIMPElementStructural>;
